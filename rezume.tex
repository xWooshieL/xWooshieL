...
\setlist[itemize]{leftmargin=*, itemsep=1pt, parsep=0pt, topsep=2pt, label={\color{pasteldot}\textbullet}}
...
\begin{minipage}[t]{0.25\textwidth}
  ...
  \IfFileExists{photo_3.5x4.5cm_300dpi.jpg}{%
    \includegraphics[width=3.2cm,height=3.2cm,keepaspectratio]{photo_3.5x4.5cm_300dpi.jpg}%
  }{}
\end{minipage}
